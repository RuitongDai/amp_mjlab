...
from src.tasks.amp_loco.config.e1_no_hand.env_cfgs import e1_no_hand_amp_flat_env_cfg
import mjlab
...
def main(
  ...
  output_dir: str = "src/assets/motions/e1_no_hand/amp/WalkandRun",
  ...
  scene = Scene(e1_no_hand_amp_flat_env_cfg().scene, device=device)
  model = scene.compile()
