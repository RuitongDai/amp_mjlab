"""RL configuration for F2 AMP locomotion task."""
...
class RslRlAmpRunnerCfg(RslRlOnPolicyRunnerCfg):
  ...
  min_normalized_std: List[float] = field(default_factory=lambda: [0.05] * 14)
  amp_body_names: tuple = ()
  amp_anchor_name: str = ""


def f2_amp_ppo_runner_cfg() -> RslRlAmpRunnerCfg:
  """Create RL runner configuration for F2 AMP locomotion task."""
  return RslRlAmpRunnerCfg(
    ...
    experiment_name="f2_amp_locomotion",
    logger="wandb",
    save_interval=500,
