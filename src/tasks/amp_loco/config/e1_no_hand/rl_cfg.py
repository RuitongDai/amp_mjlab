"""RL configuration for E1 AMP locomotion task."""
...
_MOTION_DATA_DIR = os.path.join(
  ...
  "src", "assets", "motions", "e1_no_hand", "amp",
)
...
def e1_no_hand_amp_ppo_runner_cfg() -> RslRlAmpRunnerCfg:
  """Create RL runner configuration for E1 AMP locomotion task."""
  return RslRlAmpRunnerCfg(
    ...
    experiment_name="e1_no_hand_amp_locomotion",
    logger="wandb",
    save_interval=500,
