"""RL configuration for F3 AMP locomotion task."""
...
def f3_amp_ppo_runner_cfg() -> RslRlAmpRunnerCfg:
  """Create RL runner configuration for F3 AMP locomotion task."""
  return RslRlAmpRunnerCfg(
    ...
    experiment_name="f3_amp_locomotion",
    logger="wandb",
    save_interval=500,
